...
from chess_zero.env.chess_env import get_input_planes_by_state
...
class OptimizeWorker:
    ...
    def train_epoch(self, epochs):
        ...
        state_ary = state_ary.reshape(state_ary.shape[0], 1, state_ary.shape[1], state_ary.shape[2])
...
def convert_to_cheating_data(data):
    ...
    for state_fen, policy, value in data:
        ...
        # state_planes = np.array(state_fen)
        #print(state_planes)
        state_planes = get_input_planes_by_state(state_fen)
